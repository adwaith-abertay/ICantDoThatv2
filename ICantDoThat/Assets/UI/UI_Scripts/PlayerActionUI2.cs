...
public class PlayerActionUI2 : MonoBehaviour
{
    ...
    private Label activeModeLabel; // Assuming you might add this back later
    ...
    private void OnEnable()
    {
        ...
        // Hooking up the buttons using the UXML names
        ...
        if (startFireBtn != null) startFireBtn.clicked += () => PlayerActionManager.Instance.ActionStartFire();
        if (cutO2Btn != null) cutO2Btn.clicked += () => PlayerActionManager.Instance.ActionCutO2();

        /* // --- FUTURE LOGIC FOR VENTING ---
        // Uncomment these when you add the methods to PlayerActionManager
    ...
    public void RefreshButtons()
    {
        ...
        /*
        // --- FUTURE LOGIC FOR VENTING ENERGY COSTS ---
        // Change the '4' to whatever energy cost you actually want these to be
        if (ventAirlockBtn != null) ventAirlockBtn.SetEnabled(energy >= 4);
        if (ventDockedPodBtn != null) ventDockedPodBtn.SetEnabled(energy >= 4);
        */
